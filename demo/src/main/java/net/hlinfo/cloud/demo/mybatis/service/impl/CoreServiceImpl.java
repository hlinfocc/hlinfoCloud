package net.hlinfo.cloud.demo.mybatis.service.impl;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import net.hlinfo.cloud.demo.mybatis.dao.CoreDao;
...
public class CoreServiceImpl implements CoreService {
    ...
    public List queryList(String mybitsSqlId, Map<String,Object> map) {
        return this.coreDao.queryList(mybitsSqlId, map);
    }
